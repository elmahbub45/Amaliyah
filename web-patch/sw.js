const C='amaliyah-v2-52-0-adzan';
const QURAN_CACHE='amaliyah-quran-pages-v1';
const EXTERNAL_CACHE='amaliyah-external-v1';
const A=['./','./index.html','./style.css','./app.js','./icon-library.js','./reader.html','./reader.css','./reader.js','./quran.html','./quran.css','./quran.js','./quran-config.js','./quran-offline.js','./books.json','./manifest.webmanifest','./assets/icons/icon-192.png','./assets/icons/icon-512.png','./assets/audio/adzan.mp3','./assets/audio/adzan-subuh.mp3','./assets/audio/adzan-pendek.mp3'];
const PDFJS=[
