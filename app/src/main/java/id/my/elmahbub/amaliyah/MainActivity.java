...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settings.setUserAgentString(
                settings.getUserAgentString() + " AmaliyahAndroid/1.5"
        );
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(
                ...
                if ("elmahbub45.github.io".equalsIgnoreCase(host)) {
                    return false;
                }
        ...
        if (webView != null) {
            webView.post(() ->
                    webView.evaluateJavascript(
                            "window.dispatchEvent(new Event('amaliyah-prayer-timing-access-changed'))",
                            null
                    )
            );
        }
    ...
    private void playPrayerPreview(
            String soundMode,
            String prayer
    ) {
        stopPrayerPreview();
        ...
        prayerPreviewPlayer = MediaPlayer.create(
                this,
                resId
        );
        ...
        prayerPreviewPlayer.setOnCompletionListener(
                mp -> stopPrayerPreview()
        );
    ...
    public void onRequestPermissionsResult(
        ...
        if (
            ...
            webView.post(() ->
                    webView.evaluateJavascript(
                            "window.dispatchEvent(new Event('amaliyah-notification-permission-changed'))",
                            null
                    )
            );
        }
    ...
    public final class NativeBridge {
        ...
        @JavascriptInterface
        public int getPrayerSchedulerVersion() {
            return PrayerAlarmScheduler.SCHEDULER_VERSION;
        }
        ...
        public String getFcmStatus() {
            return FcmRegistration.getStatus(
                    MainActivity.this
            );
        }
                ...
                try {
                    ...
                    try {
                        startActivity(
                            ...
                            ActivityNotFoundException ignoredAgain
                    ) {}
                }
            });
        }
        ...
        public void showNotification(
            ...
            NotificationHelper.show(
                    MainActivity.this,
                    NotificationHelper.PRAYER_CHANNEL,
                    title,
                    body,
                    (int) (
        ...
        @JavascriptInterface
        public void syncPrayerSchedule(
                String payloadJson
        ) {
            PrayerAlarmScheduler.syncFromWeb(
                    MainActivity.this,
                    payloadJson
            );
        }
        ...
        public void cancelPrayerAlarms() {
            PrayerAlarmScheduler.cancelPrayerAlarms(
                    MainActivity.this
            );
        }
        ...
        @JavascriptInterface
        public void testPrayerNotification(
                String soundMode,
                String prayer
        ) {
            if (
        ...
        @JavascriptInterface
        public void previewPrayerSound(
                String soundMode,
                String prayer
        ) {
            runOnUiThread(() ->
